...
public class EveApiTest {
    ...
    public static void init() {
        ...
        try {
            ...
            LogManager.getLogger(EveApiTest.class).error("File \"test.properties\" not found!", e);
    ...
    public void hasAllEndpoints() throws IOException, EveApiException {
        LogManager.getLogger(getClass()).info("Running test: hasAllEndpoints()");
        ...
        for (Call call : callList.getCalls()) {
            ...
            if (!found) {
                LogManager.getLogger(getClass()).error("Endpoint missing: " + call.getName());
    ...
    public void testAllEndpoints() throws IOException, EveApiException {
        LogManager.getLogger(getClass()).info("Running test: testAllEndpoints()");
        CallList callList = Api.getCallList(keyId, verificationCode);
        StringBuilder missing = new StringBuilder();
        for (Call call : callList.getCalls()) {
            if (!"Character".equals(call.getType())) {
    ...
    public void getErrorResponse203() throws IOException {
        LogManager.getLogger(getClass()).info("Running test: getErrorResponse203()");
        try {
    ...
    public void getErrorResponse221() throws IOException {
        LogManager.getLogger(getClass()).info("Running test: getErrorResponse221()");
        try {
    ...
    public void getAccountBalance() throws IOException {
        LogManager.getLogger(getClass()).info("Running test: getAccountBalance()");
        try {
            Assert.assertNotNull(Api.getAccountBalance(keyId, verificationCode, characterId));
        } catch (EveApiException e) {
            LogManager.getLogger(getClass()).warn("Could not test API: " + e.getMessage());
        }
    }

    @Test
    public void getAccountStatus() throws IOException {
        LogManager.getLogger(getClass()).info("Running test: getAccountStatus()");
        try {
    ...
    public void getApiKeyInfo() throws IOException {
        LogManager.getLogger(getClass()).info("Running test: getApiKeyInfo()");
        try {
    ...
    public void getAssetList() throws IOException {
        LogManager.getLogger(getClass()).info("Running test: getAssetList()");
        try {
    ...
    public void getBookmarks() throws IOException {
        LogManager.getLogger(getClass()).info("Running test: getBookmarks()");
        try {
    ...
    public void getCalendarEventAttendees() throws IOException {
        LogManager.getLogger(getClass()).info("Running test: getCalendarEventAttendees()");
        try {
            ...
            if (events == null || events.getUpcomingEvents().size() == 0) {
                LogManager.getLogger(getClass()).warn("Could not test API: Depending request returned nothing.");
            } else {
    ...
    public void getCallList() throws IOException {
        LogManager.getLogger(getClass()).info("Running test: getCallList()");
        try {
    ...
    public void getCharacterInfo() throws IOException {
        LogManager.getLogger(getClass()).info("Running test: getCharacterInfo()");
        try {
    ...
    public void getCharacters() throws IOException {
        LogManager.getLogger(getClass()).info("Running test: getCharacters()");
        try {
    ...
    public void getCharacterSheet() throws IOException {
        LogManager.getLogger(getClass()).info("Running test: getCharacterSheet()");
        try {
    ...
    public void getChatChannels() throws IOException {
        LogManager.getLogger(getClass()).info("Running test: getChatChannels()");
        try {
    ...
    public void getClones() throws IOException {
        LogManager.getLogger(getClass()).info("Running test: getClones()");
        try {
    ...
    public void getContactList() throws IOException {
        LogManager.getLogger(getClass()).info("Running test: getContactList()");
        try {
    ...
    public void getContactNotifications() throws IOException {
        LogManager.getLogger(getClass()).info("Running test: getContactNotifications()");
        try {
    ...
    public void getContracts() throws IOException {
        LogManager.getLogger(getClass()).info("Running test: getContracts()");
        try {
    ...
    public void getFacWarStats() throws IOException {
        LogManager.getLogger(getClass()).info("Running test: getFacWarStats()");
        try {
    ...
    public void getIndustryJobs() throws IOException {
        LogManager.getLogger(getClass()).info("Running test: getIndustryJobs()");
        try {
    ...
    public void getKillLog() throws IOException {
        LogManager.getLogger(getClass()).info("Running test: getKillLog()");
        try {
    ...
    public void getLocations() throws IOException {
        LogManager.getLogger(getClass()).info("Running test: getLocations()");
        try {
    ...
    public void getMailBodies() throws IOException {
        LogManager.getLogger(getClass()).info("Running test: getMailBodies()");
        try {
    ...
    public void getMailingLists() throws IOException {
        LogManager.getLogger(getClass()).info("Running test: getMailingLists()");
        try {
    ...
    public void getMailMessages() throws IOException {
        LogManager.getLogger(getClass()).info("Running test: getMailMessages()");
        try {
    ...
    public void getMarketOrders() throws IOException {
        LogManager.getLogger(getClass()).info("Running test: getMarketOrders()");
        try {
    ...
    public void getMedals() throws IOException {
        LogManager.getLogger(getClass()).info("Running test: getMedals()");
        try {
    ...
    public void getNotifications() throws IOException {
        LogManager.getLogger(getClass()).info("Running test: getNotifications()");
        try {
    ...
    public void getNotificationTexts() throws IOException {
        LogManager.getLogger(getClass()).info("Running test: getNotificationTexts()");
        try {
    ...
    public void getResearch() throws IOException {
        LogManager.getLogger(getClass()).info("Running test: getResearch()");
        try {
    ...
    public void getSkillInTraining() throws IOException {
        LogManager.getLogger(getClass()).info("Running test: getSkillInTraining()");
        try {
    ...
    public void getSkillQueue() throws IOException {
        LogManager.getLogger(getClass()).info("Running test: getSkillQueue()");
        try {
    ...
    public void getSkills() throws IOException {
        LogManager.getLogger(getClass()).info("Running test: getSkills()");
        try {
    ...
    public void getStandings() throws IOException {
        LogManager.getLogger(getClass()).info("Running test: getStandings()");
        try {
    ...
    public void getUpcomingCalendarEvents() throws IOException {
        LogManager.getLogger(getClass()).info("Running test: getUpcomingCalendarEvents()");
        try {
    ...
    public void getWalletJournal() throws IOException {
        LogManager.getLogger(getClass()).info("Running test: getWalletJournal()");
        try {
    ...
    public void getWalletTransactions() throws IOException {
        LogManager.getLogger(getClass()).info("Running test: getWalletTransactions()");
        try {
